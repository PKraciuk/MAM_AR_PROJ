...
public class MainActivity extends AppCompatActivity {
    ...
    private Button modelMenu, editMenu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modelMenu = findViewById(R.id.ModelMenu);
        editMenu = findViewById(R.id.EditMenu);

        modelMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, ModelMenuActivity.class);
